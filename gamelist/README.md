...
Se você já tem um workflow `.github/workflows/main.yml` com o conteúdo que usamos antes,
pode mantê-lo. Este projeto também traz um workflow de exemplo em `.github/workflows/android.yml`.
